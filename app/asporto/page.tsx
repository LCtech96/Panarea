...
export default function AsportoPage() {
  ...
  const formatOrderForWhatsApp = () => {
    ...
    orders.forEach((item, index) => {
      ...
      message += `   Prezzo: €${(item.price * item.quantity).toFixed(2)}\n`
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          ...
          {orders.length === 0 ? (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Vai al menù per aggiungere prodotti
              </p>
            </div>
          ) : (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-4">
              Per ordinare da asporto, aggiungi i prodotti al carrello e invia l&apos;ordine via WhatsApp.
            </p>
            <p className="text-gray-600 dark:text-gray-400">
              Il servizio di ordinazione online sarà disponibile a breve!
            </p>
          </div>
        </section>
      </div>
