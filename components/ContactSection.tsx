...
export default function ContactSection() {
  ...
  return (
    <footer className="bg-gray-900 text-white pt-16 pb-24 md:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12 mb-8">
          ...
          <a
            ...
            className="flex items-center gap-3 bg-green-500 hover:bg-green-600 px-4 py-2 rounded-full transition-colors"
          >
            <svg
              className="w-6 h-6"
              fill="currentColor"
            ...
            <span className="text-sm md:text-base">{t('cart.sendWhatsapp')}</span>
          </a>
        </div>
        ...
        <div className="flex justify-center items-center gap-6 md:gap-8">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:opacity-90 rounded-full transition-opacity"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-12 h-12 bg-black hover:bg-gray-800 rounded-full transition-colors"
            aria-label="TikTok"
          >
            <svg
              className="w-6 h-6 text-white"
